...
describe Boleto do
  describe 'Validate' do
    ...
    it 'success register a boleto' do
      boleto = Boleto.new(bank_code: 123, agency_number: 1234, bank_account: 123456789)
      ...
      boleto = Boleto.new(bank_code: 123, agency_number: 1234, bank_account: 123456789, company_id: codeplay.id, payment_method_id: payment.id)
